...
object ScalaRunTime {
   ...
   */
  def anyValClass[T <: AnyVal](value: T): Class[T] = sys.error("Not sure how to handle this in GWT")
  ...
  def stringOf(arg: Any, maxElements: Int): String = sys.error("Not sure what to do about it. Removing for now.")
